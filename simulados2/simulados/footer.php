		...
		<div class="row">
			<div class="col-sm-3 col-lg-3">
				<div class="widget">
					...
					<address>
					<strong>Fatec Sorocaba</strong><br>
					 Av. Engenheiro Carlos Reinaldo Mendes, 2015<br>
					 Alto da Boa Vista - Sorocaba/SP</address>
					<p>
						<i class="icon-phone"></i> +55 (15) 3238-5266<br>
						<i class="icon-envelope-alt"></i> atendimento@fatec.sp.gov.br
					</p>
				</div>
			</div>
			<div class="col-sm-3 col-lg-3">
