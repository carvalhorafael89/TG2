            ...
            <ul class="slides">
              <li>
                ...
                <div class="flex-caption">
                    ...
                    <p>Realize agora seu simulado e saiba seu resultado imediatamente.</p> 
              ...
              <li>
                 ...
                 <div class="flex-caption">
                    ...
                    <p>Solicite ao professor o código da prova e comece seus testes.</p> 
                    <a href="realiza.php" class="btn btn-theme">Começar</a>
                </div>
              </li>
              <li>
                ...
                <div class="flex-caption">
                    <h3>Tempo Livre</h3> 
                    <p>Com o sistema de correção automática, você não precisa esperar.</p> 
  ...
  <!-- end slider -->
     ...
     <div class="container">
        <div class="row">
              <div class="col-lg-8">
                <div class="cta-text">
                  <h2>Sistema para realizar <span>simulados</span> on-line</h2>
                  <p> Faça seu login e comece a realizar seu simulado. Solicite ao professor o código da prova.</p>
                </div>
              </div>
              <div class="col-lg-4">
                <div class="cta-btn">
